"""
Script basico para mintear NFTs
"""
...
BLOCK_FROST_PROJECT_ID = "preprodXNgd8dUFkDrxo38TQsUSbNiEmqZ2dgCv"
...
nft1 = AssetName(b"ZOMBIE")
nft2 = AssetName(b"ZOMBIE_2")
...
my_nft_alternative = MultiAsset.from_primitive(
    {
        policy_id.payload: {  # Use policy ID created from above. We can't use policy_id here because policy_id's type  # is ScriptHash, which is not a primitive type. Instead, we use policy_id.payload (bytes)
            b"ZOMBIE": 1,  # Name of our NFT1  # Quantity of this NFT
            b"ZOMBIE_2": 1,  # Name of our NFT2  # Quantity of this NFT
        }
    }
)
...
metadata = {
    721: {  # 721 refers to the metadata label registered for NFT standard here:
        ...
        policy_id.payload.hex(): {
            "ZOMBIE": {
                "description": "This is zombie NFT minted with pycardano",
                "name": "zombieNFT",
                "id": 1,
                "image": "https://imgur.com/M9Ldlbi",
            },
            "ZOMBIE_2": {
                "description": "This is zombie NFT minted with pycardano",
                "name": "zombieNFT_2",
                "id": 2,
                "image": "https://imgur.com/CwlDlHh",
            },
        }
    }
}
