from pycardano import AssetName, AuxiliaryData, AlonzoMetadata, Transaction, BlockFrostChainContext, Network, Address, PaymentSigningKey, PaymentVerificationKey, ScriptPubkey, ScriptAll, InvalidBefore, TransactionOutput, TransactionBuilder
from datetime import datetime, timedelta
import json
from pycardano.backend.blockfrost import ApiUrls
...
# Detalles del token
asset_name = "MyToken"  # Reemplaza con el nombre de tu token
token_amount = 100_000_000_000  # Cantidad de tokens a acuñar
...
# Construir la salida con el token acuñado
